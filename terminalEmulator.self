...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'terminalEmulator' -> () From: ( | {
         ...
         connection_old = bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'terminalEmulator' -> 'connection_old' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals terminalEmulator connection_old.
'.
            | ) .
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'terminalEmulator' -> 'connection_old' -> () From: ( | {
         'ModuleInfo: Module: terminalEmulator InitialContents: FollowSlot'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'terminalEmulator' -> 'connection_old' -> () From: ( | {
         'Category: terminalEmulator\x7fModuleInfo: Module: terminalEmulator InitialContents: FollowSlot'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'terminalEmulator' -> 'connection_old' -> () From: ( | {
         'Category: i/o\x7fModuleInfo: Module: terminalEmulator InitialContents: InitializeToExpression: (\'\')'
        
         in <- ''.
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'terminalEmulator' -> 'connection_old' -> () From: ( | {
         'Category: i/o\x7fModuleInfo: Module: terminalEmulator InitialContents: InitializeToExpression: (os_file deadCopy)'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'terminalEmulator' -> 'connection_old' -> () From: ( | {
         ...
         openTmux = ( |
            | 'terminalEmulator -C > ', out, ' < ', in).
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'terminalEmulator' -> 'connection_old' -> () From: ( | {
         'Category: i/o\x7fModuleInfo: Module: terminalEmulator InitialContents: FollowSlot'
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'terminalEmulator' -> () From: ( | {
         ...
         session_old = bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'terminalEmulator' -> 'session_old' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals terminalEmulator session_old.
'.
            | ) .
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'terminalEmulator' -> 'session_old' -> () From: ( | {
         'Category: internal state\x7fModuleInfo: Module: terminalEmulator InitialContents: InitializeToExpression: (terminalEmulator connection)'
        
         connection <- bootstrap stub -> 'globals' -> 'terminalEmulator' -> 'connection' -> ().
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'terminalEmulator' -> 'session_old' -> () From: ( | {
         'Category: querying\x7fModuleInfo: Module: terminalEmulator InitialContents: FollowSlot'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'terminalEmulator' -> 'session_old' -> () From: ( | {
         'Category: insert\x7fModuleInfo: Module: terminalEmulator InitialContents: FollowSlot'
